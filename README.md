...
* `git clone https://github.com/sojolkhan/hackersojol.git`
* `cd sojol`
...
## Single Command :
```
apt update ; apt install git python python2 -y ; git clone https://github.com/sojolkhan/hackersojol.git ; cd sojol ; python2 crack.py
```
